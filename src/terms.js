  ...
  <div className="text">
    ...
    <section>
      ...
      <p>
        ...
        provided by Aibek Mazhitov under any ongoing agreement. It’s designed to
        protect us, our customers, and the general Internet community from
        unethical, irresponsible, and illegal activity.{" "}
      </p>
      <p>
        Aibek Mazhitov customers found engaging in activities prohibited by this
      ...
      <p>This policy was last reviewed on 21 December 2021. </p>
      <h3>Fair use</h3>
      <p>
      ...
      <h4>Unauthorized use of Aibek Mazhitov property</h4>
      <p>
        We prohibit the impersonation of Aibek Mazhitov, the representation of a
        significant business relationship with Aibek Mazhitov, or ownership of
        any Aibek Mazhitov property (including our Products and brand) for the
        purpose of fraudulently gaining service, custom, patronage, or user
        trust.{" "}
      </p>
